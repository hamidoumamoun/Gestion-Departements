...
class DbGeo extends SQLiteOpenHelper {
    ...
    public static DbGeo getInstance(Context ctxt) {
        if (instance == null) {
            instance = new DbGeo(ctxt);
        }
        return instance;
    }
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (72,'Aquitaine')");
